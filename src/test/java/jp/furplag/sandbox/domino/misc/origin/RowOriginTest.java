...
//    assertEquals("select * from default", new RowOrigin() { @Override public String defaultName() { return "default";}}.select(SelectBuilder.newInstance(config)).getSql().toString());
    ...
    assertEquals("select * from ONE", new Zero.One().select(SelectBuilder.newInstance(config), null, null, null).getSql().toString());
  ...
  public static void main(String[] args) {
    System.out.println(new Zero.One().select(SelectBuilder.newInstance(config)).getSql().toString());
